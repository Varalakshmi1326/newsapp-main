...
//     const url=`https://newsapi.org/v2/top-headlines?&category=${this.props.category}&category=${this.props.category}&category=${this.props.category}&apiKey=bcaa5e6f53f94843be283e2c55c52bb6&page=${this.state.page}&pageSize=${this.props.pageSize}`;
...
//   }
  ...
  async componentDidMount(){
    let url=`https://newsapi.org/v2/top-headlines?&category=${this.props.category}&category=${this.props.category}&category=${this.props.category}&apiKey=bcaa5e6f53f94843be283e2c55c52bb6&page=1&pageSize=${this.props.pageSize}`;
    this.setState({loading:true});
    let data=await fetch(url);
    let parsedData=await data.json()
    console.log(parsedData)
    ...
    handlePrevClick=async()=>{
        ...
        let url=`https://newsapi.org/v2/top-headlines?&category=${this.props.category}&category=${this.props.category}&category=${this.props.category}&apiKey=bcaa5e6f53f94843be283e2c55c52bb6&page=${this.state.page-1}&pageSize=${this.props.pageSize}`;
        this.setState({loading:true});
        let data=await fetch(url);
        let parsedData=await data.json()
        console.log(parsedData)
    ...
    // let url=`https://newsapi.org/v2/top-headlines?&category=${this.props.category}&category=${this.props.category}&category=${this.props.category}&apiKey=bcaa5e6f53f94843be283e2c55c52bb6&page=${this.state.page+1}&pageSize=20`;
    // let data=await fetch(url);
    // let parsedData=await data.json()
    // console.log(parsedData)
    // // this.setState({articles:parsedData.articles})
